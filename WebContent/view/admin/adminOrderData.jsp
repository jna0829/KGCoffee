				...
				<div class="content">
						...
						<form action="#" method="post">
							<div class="content_container">
								...
								<div class="content_container_sub">
									...
									<div class="con-date">
										<label class="con-label">날짜 선택</label> <input type="date"
											id="date" min="1800-01-01"> <select id="dateType">
								...
								<div class="content_container_sub">
									...
									<div class="con-menu">
										<label class="con-label">메뉴검색</label> <input type="text"
					...
					<div class="chart_content_bax">
						...
						<div class="chart_container">
							...
							<div class="chart_ex">
								<h1>[ 데이터 분석 검색방법 ]</h1>
								<b class="chart_ex_b"> < 나이대 베스트 메뉴 ></b><br> 
								1) 연령별 분석(부메뉴) 선택 <br> 
								2) 검색 버튼 클릭 <br><br> 
								<b class="chart_ex_b"> < 메뉴별 총 주문량 > </b><br>
								1) 메뉴별 분석(부메뉴) 선택 <br> 
								2) 날짜 (전체, 년, 월, 일)을 선택 <br>
								3) 메뉴 이름 입력 <br>
								4) 검색 버튼 클릭 <br><br> 
								<b class="chart_ex_b"> < 매장별 총 주문량 > </b><br>
								1) 매장 분석(부메뉴) 선택 <br> 
								2) 날짜 (전체, 년, 월, 일)을 선택<br>
								3) 매장 이름 입력 <br>
								4) 검색 버튼 클릭 <br>
